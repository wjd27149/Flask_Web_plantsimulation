...
Revision ID: 00b732e7df54
Revises: 9bd2dd58940d
Create Date: 2025-04-01 17:41:32.431121
...
revision = '00b732e7df54'
down_revision = '9bd2dd58940d'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('operation', schema=None) as batch_op:
        batch_op.add_column(sa.Column('o_number', sa.Integer(), nullable=True))
